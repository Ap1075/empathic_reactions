...
# messages=root+'/data/responses/data/messages.csv' OG
messages=root+'/data/responses/data/messages_with_hindi.csv'
...
facebook_fasttext_common_crawl=jn(root,'hindi2vec.vec.zip')
# facebook_fasttext_common_crawl=jn(root,'cc.hi.300.vec.zip')
